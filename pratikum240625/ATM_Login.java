...
public class ATM_Login extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnLogin, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 207, Short.MAX_VALUE)
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        String pin = new String(txtPin.getText());
        if (pin.isEmpty()){
            JOptionPane.showMessageDialog(this, "PIN tidak boleh Kosong!!");
            return;
        }
        
        if(!pin.matches("\\d+")){
            JOptionPane.showMessageDialog(this, "PIN hrus berupa angka!");
        }
        if (pin.equals("1234")){
